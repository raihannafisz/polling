  ...
  >
    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
      ...
      >
        ...
        >
          ...
          <button
            id="navAction"
            class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-2 px-6 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
          >
            Login
          </button>
          <button
    ...
    <div class="pt-24">
      ...
      >
        ...
        >
          <p class="uppercase tracking-loose w-full">LOREMMMMMM IPSUM DOLOR</p>
          ...
          <p class="leading-normal text-2xl mb-8">
            ...
            cursus vitae congue mauris. Ipsum a arcu cursus vitae congue mauris.
            Malesuada fames ac turpis egestas maecenas pharetra convallis
            posuere morbi. Ante metus dictum at tempor.
          </p>
          <button
...
{{-- menampilkan poll populer (tulis ulang)--}}
